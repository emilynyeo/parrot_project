...
captivewild_legend <- c(Captive="purple4", "Wild, free ranging"="seagreen", 
                        "Wild, seized from traffickers"="goldenrod",
                        "Crate 1: Unknown origin" = "magenta3", 
                        "Crate 2: Unknown origin" = "firebrick3")
...
gg_bray16n_captiveprobiotic <- plot_ordination(phyloseq16n, phylo16n_ord, 
                                               type = "samples", 
                                               color = "Captive.Wild", 
...
gg_bray16n_captivelocation <- plot_ordination(phyloseq16n, phylo16n_ord, 
                                              type = "samples", color = "Captive.Wild", shape = "Country")+
  scale_shape_manual(values=c(19,21))+
  scale_color_manual(values=captivewild_legend)+
  labs(subtitle=paste0("Bacteria (Stress: ", round(phylo16n_ord$stress, 2),")")) +
...
gg_bray16n_captivelocation <- plot_ordination(phyloseq16n, phylo16n_ord, 
                                              type = "samples", color = "Site.name", shape = "Captive.Wild") +
...
gg_bray16WITHREN_givenprobiotic <- plot_ordination(phyloseq16all, phylo16all_ord, 
...
gg_bray16WITHREN_givenprobiotic_samples_blanked <- plot_ordination(phyloseq16all, 
                                                                   phylo16all_ord, type = "samples", color = "Captive.Wild", shape="Given.probiotic")+
  scale_shape_manual(values=c(19,21)) +
...
captivewild_legend
gg_bray16WITHREN_givenprobiotics_nomystery <- plot_ordination(phyloseq16all, 
                                                              phylo16all_ord, 
                                                              type = "samples", 
                                                              color = "Captive.Wild", 
                                                              shape = "Given.probiotic")+
  scale_shape_manual(values=c(19,21)) +
  scale_color_manual(values=c(Captive="purple4", 
                              "Wild, free ranging"="seagreen", 
                              "Wild, seized from traffickers"="goldenrod",
                              "Crate 1: Unknown origin" = rgb(0,0,0,0), 
                              "Crate 2: Unknown origin" = rgb(0,0,0,0)))+
  labs(subtitle=paste0("Bacteria (Stress: ", round(phylo16all_ord$stress, 2),")")) +
...
onlyweirdsamp <- prune_taxa(taxa_sums(prune_samples(samples=weirdsamps, phyloseq18_nohost))>0, 
                            prune_samples(samples=weirdsamps, phyloseq18_nohost))
...
gg_bray18_captivetube <- plot_ordination(phyloseq18_nohost, phylo18_ord, 
                                         type = "samples", color = "Captive.Wild", 
                                         shape = "Tube.type")+
  scale_shape_manual(values=c(19,21)) +
  scale_color_manual(values=captivewild_legend)+
