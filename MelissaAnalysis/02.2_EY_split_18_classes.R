...
for ( o in c("nano","miseq")) {
  ...
  phyloseq18_broadcat <- phyloseq(otu_table(phyloseq18, taxa_are_rows = TRUE), 
                                  tax_table(catTax), sample_data(phyloseq18))
  ...
  color_leg_broadcat2 <- c(Arachnid="black", Presumed_host="darkgrey",
